...
function installBinary {
    line
    echo -e "$GREEN Insert link to the BINARY file or archive (Example: https://github.com/desmos-labs/desmos/releases/download/v0.17.5/desmos-amd64.zip)$NORMAL"
    line
    read -p "Link: " LINK
...
function greeting {
line
echo -e "$YELLOW Snapshot Services provided by :$NORMAL"
